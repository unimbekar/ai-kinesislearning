...
public class StockTradesProcessor {
    ...
    private static final Logger PROCESSOR_LOGGER =
            Logger.getLogger("kinesis.processor");
...
//        String applicationName = args[0];
        String applicationName = System.getProperty("application-name", "upen-kinesis-stock-consumer");
//        String streamName = args[1];
        String streamName = System.getProperty("stream-name", "my-test-stream");
